 ...
 */
@Embeddable
public class RecpediPK implements Serializable {
    ...
    public RecpediPK(short codemp, short coddel, short codcli, Character tipped, String serped, short ejeped, int numped) {
        this.codemp = codemp;
        this.coddel = coddel;
        this.codcli = codcli;
        this.tipped = tipped;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof RecpediPK)) {
            return false;
        }
        RecpediPK other = (RecpediPK) object;
    ...
    public String toString() {
        return "javaapplication1.RecpediPK[ codemp=" + codemp + ", coddel=" + coddel + ", codcli=" + codcli + ", tipped=" + tipped + ", serped=" + serped + ", ejeped=" + ejeped + ", numped=" + numped + " ]";
    }
