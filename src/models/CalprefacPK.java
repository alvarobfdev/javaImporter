 ...
 */
@Embeddable
public class CalprefacPK implements Serializable {
    ...
    public CalprefacPK(short codemp, short cenfac, short codcli, String aplica, Character baremo, String bastar, Date feccal) {
        this.codemp = codemp;
        this.cenfac = cenfac;
        this.codcli = codcli;
        this.aplica = aplica;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CalprefacPK)) {
            return false;
        }
        CalprefacPK other = (CalprefacPK) object;
    ...
    public String toString() {
        return "javaapplication1.CalprefacPK[ codemp=" + codemp + ", cenfac=" + cenfac + ", codcli=" + codcli + ", aplica=" + aplica + ", baremo=" + baremo + ", bastar=" + bastar + ", feccal=" + feccal + " ]";
    }
