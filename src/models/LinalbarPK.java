 ...
 */
@Embeddable
public class LinalbarPK implements Serializable {
    ...
    public LinalbarPK(short codemp, short coddel, short codcli, Character tipalb, String seralb, short ejerci, int numalb, short numlin) {
        this.codemp = codemp;
        this.coddel = coddel;
        this.codcli = codcli;
        this.tipalb = tipalb;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof LinalbarPK)) {
            return false;
        }
        LinalbarPK other = (LinalbarPK) object;
    ...
    public String toString() {
        return "javaapplication1.LinalbarPK[ codemp=" + codemp + ", coddel=" + coddel + ", codcli=" + codcli + ", tipalb=" + tipalb + ", seralb=" + seralb + ", ejerci=" + ejerci + ", numalb=" + numalb + ", numlin=" + numlin + " ]";
    }
